...
func (r ApiGetMultiCloudNetworksRequest) ProjectId(projectId int32) ApiGetMultiCloudNetworksRequest {
	r.projectId = &projectId
	return r
}

func (r ApiGetMultiCloudNetworksRequest) Execute() (*MultiCloudNetwork, *http.Response, error) {
	return r.ApiService.GetMultiCloudNetworksExecute(r)
}

/*
GetMultiCloudNetworks Get the Direct Connect multi-cloud network configuration across the EMEA, AMER, and APAC macro regions.
...
func (a *NetworkAPIService) GetMultiCloudNetworksExecute(r ApiGetMultiCloudNetworksRequest) (*MultiCloudNetwork, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/multi-cloud-networks"
...
func (r ApiGetProjectConnectivityCenterByIdRequest) Execute() (*ConnectivityCenter, *http.Response, error) {
	return r.ApiService.GetProjectConnectivityCenterByIdExecute(r)
}

/*
GetProjectConnectivityCenterById Get connectivity center by ID
...
func (a *NetworkAPIService) GetProjectConnectivityCenterByIdExecute(r ApiGetProjectConnectivityCenterByIdRequest) (*ConnectivityCenter, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/connectivity-centers/{id}"
...
// Filter by location using not equal operator.
func (r ApiListConnectivityCentersRequest) LocationNe(locationNe string) ApiListConnectivityCentersRequest {
	r.locationNe = &locationNe
	return r
}

// Filter by location using contains operator.
func (r ApiListConnectivityCentersRequest) LocationLike(locationLike string) ApiListConnectivityCentersRequest {
	r.locationLike = &locationLike
	return r
}

// Filter by location using does not contain operator.
func (r ApiListConnectivityCentersRequest) LocationNlike(locationNlike string) ApiListConnectivityCentersRequest {
	r.locationNlike = &locationNlike
	return r
}
...
// Filter by network type using equality.
func (r ApiListConnectivityCentersRequest) NetworkType(networkType string) ApiListConnectivityCentersRequest {
	r.networkType = &networkType
	return r
}

// Filter by network type using not equal operator.
func (r ApiListConnectivityCentersRequest) NetworkTypeNe(networkTypeNe string) ApiListConnectivityCentersRequest {
	r.networkTypeNe = &networkTypeNe
	return r
}

func (r ApiListConnectivityCentersRequest) Execute() ([]ConnectivityCenter, *http.Response, error) {
	return r.ApiService.ListConnectivityCentersExecute(r)
}

/*
ListConnectivityCenters List connectivity centers in direct connect network
...
func (a *NetworkAPIService) ListConnectivityCentersExecute(r ApiListConnectivityCentersRequest) ([]ConnectivityCenter, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/connectivity-centers"
	...
	if r.locationNe != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "location.ne", r.locationNe, "form", "")
	}
	if r.locationLike != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "location.like", r.locationLike, "form", "")
	}
	if r.locationNlike != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "location.nlike", r.locationNlike, "form", "")
	}
	if r.macroRegion != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "macroRegion", r.macroRegion, "form", "")
	}
	if r.networkType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "networkType", r.networkType, "form", "")
	}
	if r.networkTypeNe != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "networkType.ne", r.networkTypeNe, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiPostMultiCloudNetworkActionRequest) PostMultiCloudNetworkActionRequest(postMultiCloudNetworkActionRequest PostMultiCloudNetworkActionRequest) ApiPostMultiCloudNetworkActionRequest {
	r.postMultiCloudNetworkActionRequest = &postMultiCloudNetworkActionRequest
	return r
}

// Unused, created for future API extention. Will be ignored if used.
func (r ApiPostMultiCloudNetworkActionRequest) ProjectId(projectId int32) ApiPostMultiCloudNetworkActionRequest {
	r.projectId = &projectId
	return r
}

func (r ApiPostMultiCloudNetworkActionRequest) Execute() ([]MultiCloudNetwork, *http.Response, error) {
	return r.ApiService.PostMultiCloudNetworkActionExecute(r)
}

/*
PostMultiCloudNetworkAction Perform an action on multi-cloud network resources (enable/disable).
...
func (a *NetworkAPIService) PostMultiCloudNetworkActionExecute(r ApiPostMultiCloudNetworkActionRequest) ([]MultiCloudNetwork, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/multi-cloud-networks/actions"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.postMultiCloudNetworkActionRequest == nil {
		return localVarReturnValue, nil, reportError("postMultiCloudNetworkActionRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postMultiCloudNetworkActionRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
