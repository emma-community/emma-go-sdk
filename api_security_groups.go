...
func (r ApiGetSecurityGroupRequest) ProjectId(projectId int32) ApiGetSecurityGroupRequest {
...
// Unused, created for future API extention. Will be ignored if used.
func (r ApiGetSecurityGroupsRequest) ProjectId(projectId int32) ApiGetSecurityGroupsRequest {
	r.projectId = &projectId
	return r
}
...
Security groups control TCP, UDP and ICMP protocols, or all the selected protocols at once.

Both IPv4 and IPv6 addresses are supported in the 'ipRange' field.
...
// Unused, created for future API extention. Will be ignored if used.
func (r ApiSecurityGroupInstancesRequest) ProjectId(projectId int32) ApiSecurityGroupInstancesRequest {
	r.projectId = &projectId
	return r
}
