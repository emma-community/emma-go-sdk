...
// checks if the VmNew type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmNew{}

// VmNew struct for VmNew
type VmNew struct {
	...
	// List of volumes
	Disks []VmNewDisksInner `json:"disks,omitempty"`
	// 
...
// SetDisks gets a reference to the given []VmNewDisksInner and assigns it to the Disks field.
...
func (o VmNew) MarshalJSON() ([]byte, error) {
...
func (o VmNew) ToMap() (map[string]interface{}, error) {
...
type NullableVmNew struct {
	value *VmNew
	isSet bool
}

func (v NullableVmNew) Get() *VmNew {
	return v.value
}

func (v *NullableVmNew) Set(val *VmNew) {
	v.value = val
	v.isSet = true
}

func (v NullableVmNew) IsSet() bool {
	return v.isSet
}

func (v *NullableVmNew) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmNew(val *VmNew) *NullableVmNew {
	return &NullableVmNew{value: val, isSet: true}
}

func (v NullableVmNew) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmNew) UnmarshalJSON(src []byte) error {
	v.isSet = true
