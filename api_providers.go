...
func (r ApiGetProviderRequest) ProjectId(projectId int32) ApiGetProviderRequest {
...
// Unused, created for future API extention. Will be ignored if used.
func (r ApiGetProvidersRequest) ProjectId(projectId int32) ApiGetProvidersRequest {
	r.projectId = &projectId
	return r
}
