...
// checks if the VolumeLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeLocation{}
...
type VolumeLocation struct {
	...
	// Country of the data center location
...
func (o VolumeLocation) ToMap() (map[string]interface{}, error) {
...
func NewNullableVolumeLocation(val *VolumeLocation) *NullableVolumeLocation {
	return &NullableVolumeLocation{value: val, isSet: true}
}
