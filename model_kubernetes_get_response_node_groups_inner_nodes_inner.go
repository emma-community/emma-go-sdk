...
// checks if the KubernetesGetResponseNodeGroupsInnerNodesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesGetResponseNodeGroupsInnerNodesInner{}

// KubernetesGetResponseNodeGroupsInnerNodesInner struct for KubernetesGetResponseNodeGroupsInnerNodesInner
type KubernetesGetResponseNodeGroupsInnerNodesInner struct {
	...
	Provider   *KubernetesGetResponseNodeGroupsInnerNodesInnerProvider   `json:"provider,omitempty"`
	Location   *KubernetesGetResponseNodeGroupsInnerNodesInnerLocation   `json:"location,omitempty"`
	DataCenter *KubernetesGetResponseNodeGroupsInnerNodesInnerDataCenter `json:"dataCenter,omitempty"`
	Os         *KubernetesGetResponseNodeGroupsInnerNodesInnerOs         `json:"os,omitempty"`
	...
	Cost          *KubernetesGetResponseNodeGroupsInnerNodesInnerCost                 `json:"cost,omitempty"`
	SecurityGroup *KubernetesGetResponseNodeGroupsInnerNodesInnerSecurityGroup        `json:"securityGroup,omitempty"`
	Accelerator   *KubernetesGetResponseNodeGroupsInnerNodesInnerAccelerator          `json:"accelerator,omitempty"`
...
func NewKubernetesGetResponseNodeGroupsInnerNodesInner() *KubernetesGetResponseNodeGroupsInnerNodesInner {
	this := KubernetesGetResponseNodeGroupsInnerNodesInner{}
	return &this
}
...
func (o *KubernetesGetResponseNodeGroupsInnerNodesInner) GetProvider() KubernetesGetResponseNodeGroupsInnerNodesInnerProvider {
	if o == nil || IsNil(o.Provider) {
		var ret KubernetesGetResponseNodeGroupsInnerNodesInnerProvider
		return ret
	}
	return *o.Provider
}
...
// SetProvider gets a reference to the given KubernetesGetResponseNodeGroupsInnerNodesInnerProvider and assigns it to the Provider field.
...
func (o *KubernetesGetResponseNodeGroupsInnerNodesInner) GetLocation() KubernetesGetResponseNodeGroupsInnerNodesInnerLocation {
	if o == nil || IsNil(o.Location) {
		var ret KubernetesGetResponseNodeGroupsInnerNodesInnerLocation
		return ret
	}
	return *o.Location
}
...
// SetLocation gets a reference to the given KubernetesGetResponseNodeGroupsInnerNodesInnerLocation and assigns it to the Location field.
...
func (o *KubernetesGetResponseNodeGroupsInnerNodesInner) GetDataCenter() KubernetesGetResponseNodeGroupsInnerNodesInnerDataCenter {
	if o == nil || IsNil(o.DataCenter) {
		var ret KubernetesGetResponseNodeGroupsInnerNodesInnerDataCenter
		return ret
	}
	return *o.DataCenter
}
...
// SetDataCenter gets a reference to the given KubernetesGetResponseNodeGroupsInnerNodesInnerDataCenter and assigns it to the DataCenter field.
...
func (o *KubernetesGetResponseNodeGroupsInnerNodesInner) GetOs() KubernetesGetResponseNodeGroupsInnerNodesInnerOs {
	if o == nil || IsNil(o.Os) {
		var ret KubernetesGetResponseNodeGroupsInnerNodesInnerOs
		return ret
	}
	return *o.Os
}
...
// SetOs gets a reference to the given KubernetesGetResponseNodeGroupsInnerNodesInnerOs and assigns it to the Os field.
...
func (o *KubernetesGetResponseNodeGroupsInnerNodesInner) GetCost() KubernetesGetResponseNodeGroupsInnerNodesInnerCost {
	if o == nil || IsNil(o.Cost) {
		var ret KubernetesGetResponseNodeGroupsInnerNodesInnerCost
		return ret
	}
	return *o.Cost
}
...
// SetCost gets a reference to the given KubernetesGetResponseNodeGroupsInnerNodesInnerCost and assigns it to the Cost field.
...
func (o *KubernetesGetResponseNodeGroupsInnerNodesInner) GetSecurityGroup() KubernetesGetResponseNodeGroupsInnerNodesInnerSecurityGroup {
	if o == nil || IsNil(o.SecurityGroup) {
		var ret KubernetesGetResponseNodeGroupsInnerNodesInnerSecurityGroup
		return ret
	}
...
// SetSecurityGroup gets a reference to the given KubernetesGetResponseNodeGroupsInnerNodesInnerSecurityGroup and assigns it to the SecurityGroup field.
...
func (o *KubernetesGetResponseNodeGroupsInnerNodesInner) GetAccelerator() KubernetesGetResponseNodeGroupsInnerNodesInnerAccelerator {
	if o == nil || IsNil(o.Accelerator) {
		var ret KubernetesGetResponseNodeGroupsInnerNodesInnerAccelerator
		return ret
	}
...
// SetAccelerator gets a reference to the given KubernetesGetResponseNodeGroupsInnerNodesInnerAccelerator and assigns it to the Accelerator field.
...
func (o KubernetesGetResponseNodeGroupsInnerNodesInner) MarshalJSON() ([]byte, error) {
...
func (o KubernetesGetResponseNodeGroupsInnerNodesInner) ToMap() (map[string]interface{}, error) {
...
type NullableKubernetesGetResponseNodeGroupsInnerNodesInner struct {
	value *KubernetesGetResponseNodeGroupsInnerNodesInner
	isSet bool
}

func (v NullableKubernetesGetResponseNodeGroupsInnerNodesInner) Get() *KubernetesGetResponseNodeGroupsInnerNodesInner {
	return v.value
}

func (v *NullableKubernetesGetResponseNodeGroupsInnerNodesInner) Set(val *KubernetesGetResponseNodeGroupsInnerNodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesGetResponseNodeGroupsInnerNodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesGetResponseNodeGroupsInnerNodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesGetResponseNodeGroupsInnerNodesInner(val *KubernetesGetResponseNodeGroupsInnerNodesInner) *NullableKubernetesGetResponseNodeGroupsInnerNodesInner {
	return &NullableKubernetesGetResponseNodeGroupsInnerNodesInner{value: val, isSet: true}
}

func (v NullableKubernetesGetResponseNodeGroupsInnerNodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesGetResponseNodeGroupsInnerNodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
