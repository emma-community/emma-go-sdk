...
// checks if the SpotVmCost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotVmCost{}

// SpotVmCost struct for SpotVmCost
type SpotVmCost struct {
	// Cost period
	Unit *string `json:"unit,omitempty"`
	// Currency of cost
	Currency *string `json:"currency,omitempty"`
	// Cost of the spot instance for the period
	Price *float32 `json:"price,omitempty"`
	// Minimal cost of the spot instance for the period
	MinPrice *float32 `json:"minPrice,omitempty"`
	// Maximal cost of the spot instance for the period
...
func (o SpotVmCost) MarshalJSON() ([]byte, error) {
...
func (o SpotVmCost) ToMap() (map[string]interface{}, error) {
...
type NullableSpotVmCost struct {
	value *SpotVmCost
	isSet bool
}

func (v NullableSpotVmCost) Get() *SpotVmCost {
	return v.value
}

func (v *NullableSpotVmCost) Set(val *SpotVmCost) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotVmCost) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotVmCost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotVmCost(val *SpotVmCost) *NullableSpotVmCost {
	return &NullableSpotVmCost{value: val, isSet: true}
}

func (v NullableSpotVmCost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotVmCost) UnmarshalJSON(src []byte) error {
	v.isSet = true
