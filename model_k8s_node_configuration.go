...
// checks if the K8sNodeConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &K8sNodeConfiguration{}

// K8sNodeConfiguration struct for K8sNodeConfiguration
type K8sNodeConfiguration struct {
	// Configuration ID
	...
	Accelerator *K8sNodeConfigurationAccelerator `json:"accelerator,omitempty"`
	LocalDisks  *K8sNodeConfigurationLocalDisks  `json:"localDisks,omitempty"`
	Cost        *K8sNodeConfigurationCost        `json:"cost,omitempty"`
}
...
func (o *K8sNodeConfiguration) GetAccelerator() K8sNodeConfigurationAccelerator {
	if o == nil || IsNil(o.Accelerator) {
		var ret K8sNodeConfigurationAccelerator
		return ret
	}
...
// SetAccelerator gets a reference to the given K8sNodeConfigurationAccelerator and assigns it to the Accelerator field.
...
func (o *K8sNodeConfiguration) GetLocalDisks() K8sNodeConfigurationLocalDisks {
	if o == nil || IsNil(o.LocalDisks) {
		var ret K8sNodeConfigurationLocalDisks
		return ret
	}
	return *o.LocalDisks
}
...
// SetLocalDisks gets a reference to the given K8sNodeConfigurationLocalDisks and assigns it to the LocalDisks field.
...
func (o *K8sNodeConfiguration) GetCost() K8sNodeConfigurationCost {
	if o == nil || IsNil(o.Cost) {
		var ret K8sNodeConfigurationCost
		return ret
	}
	return *o.Cost
}
...
// SetCost gets a reference to the given K8sNodeConfigurationCost and assigns it to the Cost field.
func (o *K8sNodeConfiguration) SetCost(v K8sNodeConfigurationCost) {
	o.Cost = &v
}

func (o K8sNodeConfiguration) MarshalJSON() ([]byte, error) {
...
func (o K8sNodeConfiguration) ToMap() (map[string]interface{}, error) {
...
type NullableK8sNodeConfiguration struct {
	value *K8sNodeConfiguration
	isSet bool
}

func (v NullableK8sNodeConfiguration) Get() *K8sNodeConfiguration {
	return v.value
}

func (v *NullableK8sNodeConfiguration) Set(val *K8sNodeConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableK8sNodeConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableK8sNodeConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableK8sNodeConfiguration(val *K8sNodeConfiguration) *NullableK8sNodeConfiguration {
	return &NullableK8sNodeConfiguration{value: val, isSet: true}
}

func (v NullableK8sNodeConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableK8sNodeConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
