...
// checks if the KubernetesListResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesListResponseInner{}

// KubernetesListResponseInner struct for KubernetesListResponseInner
type KubernetesListResponseInner struct {
	...
	NodeGroups []KubernetesListResponseInnerNodeGroupsInner `json:"nodeGroups,omitempty"`
...
func NewKubernetesListResponseInner() *KubernetesListResponseInner {
	this := KubernetesListResponseInner{}
	return &this
}
...
func (o *KubernetesListResponseInner) GetNodeGroups() []KubernetesListResponseInnerNodeGroupsInner {
	if o == nil || IsNil(o.NodeGroups) {
		var ret []KubernetesListResponseInnerNodeGroupsInner
		return ret
	}
	return o.NodeGroups
}
...
// SetNodeGroups gets a reference to the given []KubernetesListResponseInnerNodeGroupsInner and assigns it to the NodeGroups field.
...
func (o KubernetesListResponseInner) MarshalJSON() ([]byte, error) {
...
func (o KubernetesListResponseInner) ToMap() (map[string]interface{}, error) {
...
type NullableKubernetesListResponseInner struct {
	value *KubernetesListResponseInner
	isSet bool
}

func (v NullableKubernetesListResponseInner) Get() *KubernetesListResponseInner {
	return v.value
}

func (v *NullableKubernetesListResponseInner) Set(val *KubernetesListResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesListResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesListResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesListResponseInner(val *KubernetesListResponseInner) *NullableKubernetesListResponseInner {
	return &NullableKubernetesListResponseInner{value: val, isSet: true}
}

func (v NullableKubernetesListResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesListResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
