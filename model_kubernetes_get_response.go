...
type KubernetesGetResponse struct {
	...
	AutoscalingConfigs []KubernetesGetResponseAutoscalingConfigsInner `json:"autoscalingConfigs,omitempty"`
}
...
func (o *KubernetesGetResponse) GetAutoscalingConfigs() []KubernetesGetResponseAutoscalingConfigsInner {
	if o == nil || IsNil(o.AutoscalingConfigs) {
		var ret []KubernetesGetResponseAutoscalingConfigsInner
		return ret
	}
...
// SetAutoscalingConfigs gets a reference to the given []KubernetesGetResponseAutoscalingConfigsInner and assigns it to the AutoscalingConfigs field.
