...
type SpotVm struct {
	...
	// 
	Networks []SpotVmNetworksInner `json:"networks,omitempty"`
	...
	// Local SSD storage directly attached to the host machine. Size is reported in terabytes (TB). Data is ephemeral and will be lost when the spot instance is stopped or deleted.
	LocalDisks []VmLocalDisksInner `json:"localDisks,omitempty"`
	Accelerator *SpotVmAccelerator `json:"accelerator,omitempty"`
...
// SetNetworks gets a reference to the given []SpotVmNetworksInner and assigns it to the Networks field.
...
// SetAccelerator gets a reference to the given SpotVmAccelerator and assigns it to the Accelerator field.
