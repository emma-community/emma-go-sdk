...
func (r ApiGetSpotRequest) ProjectId(projectId int32) ApiGetSpotRequest {
	r.projectId = &projectId
	return r
}

func (r ApiGetSpotRequest) Execute() (*SpotVm, *http.Response, error) {
...
// Unused, created for future API extention. Will be ignored if used.
func (r ApiGetSpotsRequest) ProjectId(projectId int32) ApiGetSpotsRequest {
	r.projectId = &projectId
	return r
}

func (r ApiGetSpotsRequest) Execute() ([]SpotVm, *http.Response, error) {
...
func (r ApiSpotActionsRequest) Execute() (*SpotVm, *http.Response, error) {
...
func (r ApiSpotCreateRequest) Execute() (*SpotVm, *http.Response, error) {
...
To create a GPU spot instance, include `acceleratorTypeId` and `accelerators` fields in the request body. Obtain these values from the selected configuration in the GET /v1/spots-configs response.
...
func (r ApiSpotDeleteRequest) Execute() (*SpotVm, *http.Response, error) {
