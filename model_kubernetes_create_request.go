...
// GetWorkerNodes returns the WorkerNodes field value if set, zero value otherwise.
func (o *KubernetesCreateRequest) GetWorkerNodes() []KubernetesCreateRequestWorkerNodesInner {
	if o == nil || IsNil(o.WorkerNodes) {
...
// GetWorkerNodesOk returns a tuple with the WorkerNodes field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetWorkerNodes gets a reference to the given []KubernetesCreateRequestWorkerNodesInner and assigns it to the WorkerNodes field.
