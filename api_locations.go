...
func (r ApiGetLocationRequest) ProjectId(projectId int32) ApiGetLocationRequest {
...
// Unused, created for future API extention. Will be ignored if used.
func (r ApiGetLocationsRequest) ProjectId(projectId int32) ApiGetLocationsRequest {
	r.projectId = &projectId
	return r
}
