...
// checks if the K8sNodeConfigurationCost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &K8sNodeConfigurationCost{}

// K8sNodeConfigurationCost Cost of the configuration
type K8sNodeConfigurationCost struct {
	// Cost period
...
func (o K8sNodeConfigurationCost) MarshalJSON() ([]byte, error) {
...
func (o K8sNodeConfigurationCost) ToMap() (map[string]interface{}, error) {
...
type NullableK8sNodeConfigurationCost struct {
	value *K8sNodeConfigurationCost
	isSet bool
}

func (v NullableK8sNodeConfigurationCost) Get() *K8sNodeConfigurationCost {
	return v.value
}

func (v *NullableK8sNodeConfigurationCost) Set(val *K8sNodeConfigurationCost) {
	v.value = val
	v.isSet = true
}

func (v NullableK8sNodeConfigurationCost) IsSet() bool {
	return v.isSet
}

func (v *NullableK8sNodeConfigurationCost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableK8sNodeConfigurationCost(val *K8sNodeConfigurationCost) *NullableK8sNodeConfigurationCost {
	return &NullableK8sNodeConfigurationCost{value: val, isSet: true}
}

func (v NullableK8sNodeConfigurationCost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableK8sNodeConfigurationCost) UnmarshalJSON(src []byte) error {
	v.isSet = true
