...
// checks if the VmNewDisksInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmNewDisksInner{}

// VmNewDisksInner struct for VmNewDisksInner
type VmNewDisksInner struct {
	// Volume ID
...
func (o VmNewDisksInner) MarshalJSON() ([]byte, error) {
...
func (o VmNewDisksInner) ToMap() (map[string]interface{}, error) {
...
type NullableVmNewDisksInner struct {
	value *VmNewDisksInner
	isSet bool
}

func (v NullableVmNewDisksInner) Get() *VmNewDisksInner {
	return v.value
}

func (v *NullableVmNewDisksInner) Set(val *VmNewDisksInner) {
	v.value = val
	v.isSet = true
}

func (v NullableVmNewDisksInner) IsSet() bool {
	return v.isSet
}

func (v *NullableVmNewDisksInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmNewDisksInner(val *VmNewDisksInner) *NullableVmNewDisksInner {
	return &NullableVmNewDisksInner{value: val, isSet: true}
}

func (v NullableVmNewDisksInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmNewDisksInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
