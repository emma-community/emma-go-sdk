...
func (r ApiGetKuberNodesConfigsRequest) K8sConnectionType(k8sConnectionType string) ApiGetKuberNodesConfigsRequest {
	r.k8sConnectionType = &k8sConnectionType
	return r
}
...
func (r ApiGetKuberNodesConfigsRequest) AcceleratorTypeId(acceleratorTypeId string) ApiGetKuberNodesConfigsRequest {
	r.acceleratorTypeId = &acceleratorTypeId
	return r
}

// Minimum quantity of GPU accelerators
func (r ApiGetKuberNodesConfigsRequest) AcceleratorsMin(acceleratorsMin float32) ApiGetKuberNodesConfigsRequest {
	r.acceleratorsMin = &acceleratorsMin
	return r
}

// Maximum quantity of GPU accelerators
func (r ApiGetKuberNodesConfigsRequest) AcceleratorsMax(acceleratorsMax float32) ApiGetKuberNodesConfigsRequest {
...
func (r ApiGetKuberNodesConfigsRequest) ProjectId(projectId int32) ApiGetKuberNodesConfigsRequest {
	r.projectId = &projectId
	return r
}

func (r ApiGetKuberNodesConfigsRequest) Execute() (*GetKuberNodesConfigs200Response, *http.Response, error) {
...
Returns the list of available hardware configurations that can be used for Kubernetes cluster worker nodes.

Each configuration defines the compute resources available for a node, including:
- CPU count
- CPU type
- RAM size
- system disk size
...
Available configurations depend on the cloud provider and data center. Therefore, they must be retrieved before creating or updating a Kubernetes cluster.

This endpoint allows searching and filtering configurations using parameters listed in the **Parameters** section.

The selected configuration should be used when calling the **Kubernetes cluster creation** or **cluster update** endpoints, where these parameters define the specification of worker nodes.
...
//  @return GetKuberNodesConfigs200Response
func (a *ComputeInstancesConfigurationsAPIService) GetKuberNodesConfigsExecute(r ApiGetKuberNodesConfigsRequest) (*GetKuberNodesConfigs200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetKuberNodesConfigs200Response
	)
	...
	if r.k8sConnectionType == nil {
		return localVarReturnValue, nil, reportError("k8sConnectionType is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "k8sConnectionType", r.k8sConnectionType, "form", "")
...
// GPU accelerator type ID
func (r ApiGetSpotConfigsRequest) AcceleratorTypeId(acceleratorTypeId string) ApiGetSpotConfigsRequest {
	r.acceleratorTypeId = &acceleratorTypeId
	return r
}

// Minimum quantity of GPU accelerators
func (r ApiGetSpotConfigsRequest) AcceleratorsMin(acceleratorsMin float32) ApiGetSpotConfigsRequest {
	r.acceleratorsMin = &acceleratorsMin
	return r
}

// Maximum quantity of GPU accelerators
func (r ApiGetSpotConfigsRequest) AcceleratorsMax(acceleratorsMax float32) ApiGetSpotConfigsRequest {
	r.acceleratorsMax = &acceleratorsMax
	return r
}
...
// Unused, created for future API extention. Will be ignored if used.
func (r ApiGetSpotConfigsRequest) ProjectId(projectId int32) ApiGetSpotConfigsRequest {
	r.projectId = &projectId
	return r
}
...
When creating spot instances you need to provide the desired hardware configurations. These configurations include CPU, CPU type, RAM, volume size, volume type, and optionally GPU accelerator. Different cloud providers offer various configurations in different data centers. Therefore, before creating any compute instance, you need to verify the available configurations.

Use this endpoint as a reference for available configurations for spot instances. You can search the available configurations by different parameters (provider, location, data center, cloud network type, CPU, CPU type, RAM, volume size, volume type, price, and GPU accelerator type).
...
// Unused, created for future API extention. Will be ignored if used.
func (r ApiGetVmConfigsRequest) ProjectId(projectId int32) ApiGetVmConfigsRequest {
	r.projectId = &projectId
	return r
}
...
func (r ApiGetVmResizeConfigsRequest) VmId(vmId int32) ApiGetVmResizeConfigsRequest {
	r.vmId = &vmId
	return r
}
...
// Unused, created for future API extention. Will be ignored if used.
func (r ApiGetVmResizeConfigsRequest) ProjectId(projectId int32) ApiGetVmResizeConfigsRequest {
	r.projectId = &projectId
	return r
}
