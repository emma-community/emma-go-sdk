...
The selected configuration should be used when calling the **Kubernetes cluster creation** or **cluster update** endpoints, where these parameters define the specification of worker nodes.
	...
	@param k8sConnectionType Type of Kubernetes cluster network connectivity
	@return ApiGetKuberNodesConfigsRequest
*/
func (a *ComputeInstancesConfigurationsAPIService) GetKuberNodesConfigs(ctx context.Context, k8sConnectionType string) ApiGetKuberNodesConfigsRequest {
	return ApiGetKuberNodesConfigsRequest{
		ApiService:        a,
		ctx:               ctx,
		k8sConnectionType: k8sConnectionType,
	}
}
...
func (a *ComputeInstancesConfigurationsAPIService) GetKuberNodesConfigsExecute(r ApiGetKuberNodesConfigsRequest) (*GetKuberNodesConfigs200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/kubernetes-configs/{k8sConnectionType}"
	localVarPath = strings.Replace(localVarPath, "{"+"k8sConnectionType"+"}", url.PathEscape(parameterValueToString(r.k8sConnectionType, "k8sConnectionType")), -1)
