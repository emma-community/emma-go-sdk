...
// checks if the KubernetesCreateResponseNodeGroupsInnerNodesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesCreateResponseNodeGroupsInnerNodesInner{}

// KubernetesCreateResponseNodeGroupsInnerNodesInner struct for KubernetesCreateResponseNodeGroupsInnerNodesInner
type KubernetesCreateResponseNodeGroupsInnerNodesInner struct {
	...
	Provider   *KubernetesCreateResponseNodeGroupsInnerNodesInnerProvider   `json:"provider,omitempty"`
	Location   *KubernetesCreateResponseNodeGroupsInnerNodesInnerLocation   `json:"location,omitempty"`
	DataCenter *KubernetesCreateResponseNodeGroupsInnerNodesInnerDataCenter `json:"dataCenter,omitempty"`
	...
	// Type of the cloud network (multi-cloud, isolated)
	CloudNetworkType *string `json:"cloudNetworkType,omitempty"`
	// Capacity of the RAM in gigabytes
	RamGb *int32 `json:"ramGb,omitempty"`
	// Volumes attached
	Disks []KubernetesCreateResponseNodeGroupsInnerNodesInnerDisksInner `json:"disks,omitempty"`
	// Public and private networks
	Networks      []KubernetesCreateResponseNodeGroupsInnerNodesInnerNetworksInner `json:"networks,omitempty"`
	SecurityGroup *KubernetesCreateResponseNodeGroupsInnerNodesInnerSecurityGroup  `json:"securityGroup,omitempty"`
...
func NewKubernetesCreateResponseNodeGroupsInnerNodesInner() *KubernetesCreateResponseNodeGroupsInnerNodesInner {
	this := KubernetesCreateResponseNodeGroupsInnerNodesInner{}
	return &this
}
...
func (o *KubernetesCreateResponseNodeGroupsInnerNodesInner) GetProvider() KubernetesCreateResponseNodeGroupsInnerNodesInnerProvider {
	if o == nil || IsNil(o.Provider) {
		var ret KubernetesCreateResponseNodeGroupsInnerNodesInnerProvider
		return ret
	}
	return *o.Provider
}
...
// SetProvider gets a reference to the given KubernetesCreateResponseNodeGroupsInnerNodesInnerProvider and assigns it to the Provider field.
...
func (o *KubernetesCreateResponseNodeGroupsInnerNodesInner) GetLocation() KubernetesCreateResponseNodeGroupsInnerNodesInnerLocation {
	if o == nil || IsNil(o.Location) {
		var ret KubernetesCreateResponseNodeGroupsInnerNodesInnerLocation
		return ret
	}
	return *o.Location
}
...
// SetLocation gets a reference to the given KubernetesCreateResponseNodeGroupsInnerNodesInnerLocation and assigns it to the Location field.
...
func (o *KubernetesCreateResponseNodeGroupsInnerNodesInner) GetDataCenter() KubernetesCreateResponseNodeGroupsInnerNodesInnerDataCenter {
	if o == nil || IsNil(o.DataCenter) {
		var ret KubernetesCreateResponseNodeGroupsInnerNodesInnerDataCenter
		return ret
	}
	return *o.DataCenter
}
...
// SetDataCenter gets a reference to the given KubernetesCreateResponseNodeGroupsInnerNodesInnerDataCenter and assigns it to the DataCenter field.
...
func (o *KubernetesCreateResponseNodeGroupsInnerNodesInner) GetDisks() []KubernetesCreateResponseNodeGroupsInnerNodesInnerDisksInner {
	if o == nil || IsNil(o.Disks) {
		var ret []KubernetesCreateResponseNodeGroupsInnerNodesInnerDisksInner
		return ret
	}
	return o.Disks
}
...
// SetDisks gets a reference to the given []KubernetesCreateResponseNodeGroupsInnerNodesInnerDisksInner and assigns it to the Disks field.
...
func (o *KubernetesCreateResponseNodeGroupsInnerNodesInner) GetNetworks() []KubernetesCreateResponseNodeGroupsInnerNodesInnerNetworksInner {
	if o == nil || IsNil(o.Networks) {
		var ret []KubernetesCreateResponseNodeGroupsInnerNodesInnerNetworksInner
		return ret
	}
	return o.Networks
}
...
// SetNetworks gets a reference to the given []KubernetesCreateResponseNodeGroupsInnerNodesInnerNetworksInner and assigns it to the Networks field.
...
func (o *KubernetesCreateResponseNodeGroupsInnerNodesInner) GetSecurityGroup() KubernetesCreateResponseNodeGroupsInnerNodesInnerSecurityGroup {
	if o == nil || IsNil(o.SecurityGroup) {
		var ret KubernetesCreateResponseNodeGroupsInnerNodesInnerSecurityGroup
		return ret
	}
...
// SetSecurityGroup gets a reference to the given KubernetesCreateResponseNodeGroupsInnerNodesInnerSecurityGroup and assigns it to the SecurityGroup field.
...
func (o *KubernetesCreateResponseNodeGroupsInnerNodesInner) GetLocalDisks() []KubernetesCreateResponseNodeGroupsInnerNodesInnerLocalDisksInner {
	if o == nil || IsNil(o.LocalDisks) {
		var ret []KubernetesCreateResponseNodeGroupsInnerNodesInnerLocalDisksInner
		return ret
	}
	return o.LocalDisks
}
...
// SetLocalDisks gets a reference to the given []KubernetesCreateResponseNodeGroupsInnerNodesInnerLocalDisksInner and assigns it to the LocalDisks field.
...
func (o *KubernetesCreateResponseNodeGroupsInnerNodesInner) GetAccelerator() KubernetesCreateResponseNodeGroupsInnerNodesInnerAccelerator {
	if o == nil || IsNil(o.Accelerator) {
		var ret KubernetesCreateResponseNodeGroupsInnerNodesInnerAccelerator
		return ret
	}
...
// SetAccelerator gets a reference to the given KubernetesCreateResponseNodeGroupsInnerNodesInnerAccelerator and assigns it to the Accelerator field.
...
func (o *KubernetesCreateResponseNodeGroupsInnerNodesInner) GetCost() KubernetesCreateResponseNodeGroupsInnerNodesInnerCost {
	if o == nil || IsNil(o.Cost) {
		var ret KubernetesCreateResponseNodeGroupsInnerNodesInnerCost
		return ret
	}
	return *o.Cost
}
...
// SetCost gets a reference to the given KubernetesCreateResponseNodeGroupsInnerNodesInnerCost and assigns it to the Cost field.
...
func (o KubernetesCreateResponseNodeGroupsInnerNodesInner) ToMap() (map[string]interface{}, error) {
...
type NullableKubernetesCreateResponseNodeGroupsInnerNodesInner struct {
	value *KubernetesCreateResponseNodeGroupsInnerNodesInner
	isSet bool
}

func (v NullableKubernetesCreateResponseNodeGroupsInnerNodesInner) Get() *KubernetesCreateResponseNodeGroupsInnerNodesInner {
	return v.value
}

func (v *NullableKubernetesCreateResponseNodeGroupsInnerNodesInner) Set(val *KubernetesCreateResponseNodeGroupsInnerNodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesCreateResponseNodeGroupsInnerNodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesCreateResponseNodeGroupsInnerNodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesCreateResponseNodeGroupsInnerNodesInner(val *KubernetesCreateResponseNodeGroupsInnerNodesInner) *NullableKubernetesCreateResponseNodeGroupsInnerNodesInner {
	return &NullableKubernetesCreateResponseNodeGroupsInnerNodesInner{value: val, isSet: true}
}

func (v NullableKubernetesCreateResponseNodeGroupsInnerNodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesCreateResponseNodeGroupsInnerNodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
