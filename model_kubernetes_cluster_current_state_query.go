...
// checks if the KubernetesClusterCurrentStateQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesClusterCurrentStateQuery{}

// KubernetesClusterCurrentStateQuery struct for KubernetesClusterCurrentStateQuery
type KubernetesClusterCurrentStateQuery struct {
	// Query name
	DatasetName string `json:"datasetName"`
	// ID of Kubernetes cluster
	CoreClusterId int32 `json:"coreClusterId"`
	Filters KubernetesClusterCurrentStateQueryFilters `json:"filters"`
}

type _KubernetesClusterCurrentStateQuery KubernetesClusterCurrentStateQuery
...
func NewKubernetesClusterCurrentStateQuery(datasetName string, coreClusterId int32, filters KubernetesClusterCurrentStateQueryFilters) *KubernetesClusterCurrentStateQuery {
	this := KubernetesClusterCurrentStateQuery{}
...
func (o *KubernetesClusterCurrentStateQuery) GetFilters() KubernetesClusterCurrentStateQueryFilters {
	if o == nil {
		var ret KubernetesClusterCurrentStateQueryFilters
		return ret
	}
...
func (o KubernetesClusterCurrentStateQuery) MarshalJSON() ([]byte, error) {
...
func (o KubernetesClusterCurrentStateQuery) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesClusterCurrentStateQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varKubernetesClusterCurrentStateQuery := _KubernetesClusterCurrentStateQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKubernetesClusterCurrentStateQuery)

	if err != nil {
		return err
	}

	*o = KubernetesClusterCurrentStateQuery(varKubernetesClusterCurrentStateQuery)

	return err
}

type NullableKubernetesClusterCurrentStateQuery struct {
	value *KubernetesClusterCurrentStateQuery
	isSet bool
}

func (v NullableKubernetesClusterCurrentStateQuery) Get() *KubernetesClusterCurrentStateQuery {
	return v.value
}

func (v *NullableKubernetesClusterCurrentStateQuery) Set(val *KubernetesClusterCurrentStateQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesClusterCurrentStateQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesClusterCurrentStateQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesClusterCurrentStateQuery(val *KubernetesClusterCurrentStateQuery) *NullableKubernetesClusterCurrentStateQuery {
	return &NullableKubernetesClusterCurrentStateQuery{value: val, isSet: true}
}

func (v NullableKubernetesClusterCurrentStateQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesClusterCurrentStateQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
