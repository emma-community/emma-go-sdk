...
type GetSystemVolumeConfigs200Response struct {
	...
	Content []VolumeConfiguration `json:"content,omitempty"`
...
// SetContent gets a reference to the given []VolumeConfiguration and assigns it to the Content field.
