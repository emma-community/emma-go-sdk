...
// checks if the GetSystemVolumeConfigs200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSystemVolumeConfigs200Response{}

// GetSystemVolumeConfigs200Response struct for GetSystemVolumeConfigs200Response
type GetSystemVolumeConfigs200Response struct {
	...
	Content []SystemVolumeConfiguration `json:"content,omitempty"`
...
func NewGetSystemVolumeConfigs200Response() *GetSystemVolumeConfigs200Response {
	this := GetSystemVolumeConfigs200Response{}
	return &this
}
...
func (o *GetSystemVolumeConfigs200Response) GetContent() []SystemVolumeConfiguration {
	if o == nil || IsNil(o.Content) {
		var ret []SystemVolumeConfiguration
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []SystemVolumeConfiguration and assigns it to the Content field.
...
func (o GetSystemVolumeConfigs200Response) MarshalJSON() ([]byte, error) {
...
func (o GetSystemVolumeConfigs200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetSystemVolumeConfigs200Response struct {
	value *GetSystemVolumeConfigs200Response
	isSet bool
}

func (v NullableGetSystemVolumeConfigs200Response) Get() *GetSystemVolumeConfigs200Response {
	return v.value
}

func (v *NullableGetSystemVolumeConfigs200Response) Set(val *GetSystemVolumeConfigs200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSystemVolumeConfigs200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSystemVolumeConfigs200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSystemVolumeConfigs200Response(val *GetSystemVolumeConfigs200Response) *NullableGetSystemVolumeConfigs200Response {
	return &NullableGetSystemVolumeConfigs200Response{value: val, isSet: true}
}

func (v NullableGetSystemVolumeConfigs200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSystemVolumeConfigs200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
