...
type KubernetesUpdateRequest struct {
	...
	WorkerNodes []KubernetesUpdateRequestWorkerNodesInner `json:"workerNodes"`
...
type _KubernetesUpdateRequest KubernetesUpdateRequest
...
func (o *KubernetesUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varKubernetesUpdateRequest := _KubernetesUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKubernetesUpdateRequest)

	if err != nil {
		return err
	}

	*o = KubernetesUpdateRequest(varKubernetesUpdateRequest)
