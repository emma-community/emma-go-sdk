...
// checks if the KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner{}

// KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner struct for KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner
type KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner struct {
...
func NewKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner() *KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner {
	this := KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner{}
	return &this
}
...
func (o KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) MarshalJSON() ([]byte, error) {
...
func (o KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) ToMap() (map[string]interface{}, error) {
...
type NullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner struct {
	value *KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner
	isSet bool
}

func (v NullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) Get() *KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner {
	return v.value
}

func (v *NullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) Set(val *KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner(val *KubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) *NullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner {
	return &NullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner{value: val, isSet: true}
}

func (v NullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesListResponseInnerAutoscalingConfigsInnerConfigurationPrioritiesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
