...
// checks if the KubernetesUpdateWorkerNodesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesUpdateWorkerNodesInner{}

// KubernetesUpdateWorkerNodesInner struct for KubernetesUpdateWorkerNodesInner
type KubernetesUpdateWorkerNodesInner struct {
...
type _KubernetesUpdateWorkerNodesInner KubernetesUpdateWorkerNodesInner
...
func NewKubernetesUpdateWorkerNodesInner(name string, dataCenterId string, vCpuType string, vCpu int32, ramGb int32, volumeType string, volumeGb int32) *KubernetesUpdateWorkerNodesInner {
	this := KubernetesUpdateWorkerNodesInner{}
	this.Name = name
...
func (o KubernetesUpdateWorkerNodesInner) MarshalJSON() ([]byte, error) {
...
func (o KubernetesUpdateWorkerNodesInner) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesUpdateWorkerNodesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varKubernetesUpdateWorkerNodesInner := _KubernetesUpdateWorkerNodesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKubernetesUpdateWorkerNodesInner)

	if err != nil {
		return err
	}

	*o = KubernetesUpdateWorkerNodesInner(varKubernetesUpdateWorkerNodesInner)

	return err
}

type NullableKubernetesUpdateWorkerNodesInner struct {
	value *KubernetesUpdateWorkerNodesInner
	isSet bool
}

func (v NullableKubernetesUpdateWorkerNodesInner) Get() *KubernetesUpdateWorkerNodesInner {
	return v.value
}

func (v *NullableKubernetesUpdateWorkerNodesInner) Set(val *KubernetesUpdateWorkerNodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesUpdateWorkerNodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesUpdateWorkerNodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesUpdateWorkerNodesInner(val *KubernetesUpdateWorkerNodesInner) *NullableKubernetesUpdateWorkerNodesInner {
	return &NullableKubernetesUpdateWorkerNodesInner{value: val, isSet: true}
}

func (v NullableKubernetesUpdateWorkerNodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesUpdateWorkerNodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
