...
type VmResizeConfiguration struct {
	...
	// Provider-specific compute type identifier
	ProviderComputeType *string `json:"providerComputeType,omitempty"`
	Accelerator *VmConfigurationAccelerator `json:"accelerator,omitempty"`
...
// GetProviderComputeType returns the ProviderComputeType field value if set, zero value otherwise.
func (o *VmResizeConfiguration) GetProviderComputeType() string {
	if o == nil || IsNil(o.ProviderComputeType) {
		var ret string
		return ret
	}
	return *o.ProviderComputeType
}

// GetProviderComputeTypeOk returns a tuple with the ProviderComputeType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmResizeConfiguration) GetProviderComputeTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ProviderComputeType) {
		return nil, false
	}
	return o.ProviderComputeType, true
}
...
// SetProviderComputeType gets a reference to the given string and assigns it to the ProviderComputeType field.
func (o *VmResizeConfiguration) SetProviderComputeType(v string) {
	o.ProviderComputeType = &v
}
...
func (o *VmResizeConfiguration) GetAccelerator() VmConfigurationAccelerator {
	if o == nil || IsNil(o.Accelerator) {
		var ret VmConfigurationAccelerator
		return ret
	}
...
// SetAccelerator gets a reference to the given VmConfigurationAccelerator and assigns it to the Accelerator field.
...
func (o VmResizeConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProviderComputeType) {
		toSerialize["providerComputeType"] = o.ProviderComputeType
	}
