...
// checks if the SystemVolumeConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemVolumeConfiguration{}

// SystemVolumeConfiguration struct for SystemVolumeConfiguration
type SystemVolumeConfiguration struct {
...
func NewSystemVolumeConfiguration() *SystemVolumeConfiguration {
	this := SystemVolumeConfiguration{}
	return &this
}
...
func (o SystemVolumeConfiguration) MarshalJSON() ([]byte, error) {
...
func (o SystemVolumeConfiguration) ToMap() (map[string]interface{}, error) {
...
type NullableSystemVolumeConfiguration struct {
	value *SystemVolumeConfiguration
	isSet bool
}

func (v NullableSystemVolumeConfiguration) Get() *SystemVolumeConfiguration {
	return v.value
}

func (v *NullableSystemVolumeConfiguration) Set(val *SystemVolumeConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemVolumeConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemVolumeConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemVolumeConfiguration(val *SystemVolumeConfiguration) *NullableSystemVolumeConfiguration {
	return &NullableSystemVolumeConfiguration{value: val, isSet: true}
}

func (v NullableSystemVolumeConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemVolumeConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
